...
static const char *fonts[]          		= { "JetBrainsMono Nerd Font:size=10", "fontello:size=30", "icomoon:size=11"};
...
static const char col_dwm[]        			= "#005577";
...
static const char col_gray[]						= "#bbc2cf";
static const char *colors[][3]      		= {
	/*               fg         bg         border   */
	[SchemeNorm] 	   	 = { col_white, 			col_gray1, 		col_dwm },
	[SchemeSel]  	     = { col_white, 			col_gray1,  	col_dwm },

	[SchemeTag]        = { col_gray,    		col_gray1,  	col_cyan },
  [SchemeTag1]       = { col_yellow,   		col_gray1,  	col_cyan },
	[SchemeTag2]       = { col_blue,       	col_gray1,  	col_cyan },
  [SchemeTag3]       = { col_green,   		col_gray1,  	col_cyan },
  [SchemeTag4]       = { col_red,    			col_gray1,  	col_cyan },
  [SchemeTag5]       = { col_blue,  			col_gray1,  	col_cyan },
	[SchemeTag6]       = { col_yellow,     	col_gray1,  	col_cyan },
...
static const char* traymenu[]      = { "tray.sh", NULL };
...
static const char *appmenu[]  = { "appsmenu.sh", NULL };
...
/*===================================================================================================*/	
	...
	{ ControlMask,                  XK_period,		scratchpad_show, 		{0} },
	{ ControlMask,		              XK_comma, 		scratchpad_hide, 		{0} },
	{ ControlMask|ShiftMask,        XK_period,		scratchpad_remove,	{0} },
